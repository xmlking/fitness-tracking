...
System.register(['lodash', 'jquery', 'jquery.flot', 'app/core/utils/kbn', 'app/core/time_series2', 'app/plugins/sdk'], function(exports_1) {
    var __extends = (this && this.__extends) || function (d, b) {
        for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
        function __() { this.constructor = d; }
        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
    };
    var lodash_1, jquery_1, kbn_1, time_series2_1, sdk_1;
    var panelDefaults, SingleStatCtrl;
    ...
    return {
        ...
        execute: function() {
            ...
            SingleStatCtrl = (function (_super) {
                ...
                /** @ngInject */
                function SingleStatCtrl($scope, $injector, $location, linkSrv, templateSrv) {
                ...
                SingleStatCtrl.prototype.initEditMode = function () {
                ...
                SingleStatCtrl.prototype.refreshData = function (datasource) {
                    var _this = this;
                ...
                SingleStatCtrl.prototype.loadSnapshot = function (snapshotData) {
                    var _this = this;
                    // give element time to get attached and get dimensions
                    this.$timeout(function () { return _this.dataHandler(snapshotData); }, 50);
                };
                SingleStatCtrl.prototype.dataHandler = function (results) {
                    this.series = lodash_1.default.map(results.data, this.seriesHandler.bind(this));
                    this.render();
                };
                ...
                SingleStatCtrl.prototype.render = function () {
                    var data = {};
                    this.setValues(data);
                ...
                SingleStatCtrl.templateUrl = 'public/app/plugins/panel/singlestat/module.html';
