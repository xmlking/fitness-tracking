...
System.register(['../../../../../test/lib/common', '../module', 'angular', 'jquery', '../../../../../test/specs/helpers', '../../../../core/time_series2', 'moment'], function(exports_1) {
    var common_1, angular_1, jquery_1, helpers_1, time_series2_1, moment_1;
    return {
        setters:[
            function (common_1_1) {
                common_1 = common_1_1;
                    ...
                    common_1.describe(desc, function () {
                        ...
                        ctx.setup = function (setupFunc) {
                            ...
                            common_1.beforeEach(common_1.angularMocks.inject(function ($rootScope, $compile) {
                                ...
                                ctrl.otherPanelInFullscreenMode = common_1.sinon.spy();
                                ctrl.renderingCompleted = common_1.sinon.spy();
                                ctrl.hiddenSeries = {};
