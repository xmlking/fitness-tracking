...
System.register(['lodash', 'app/plugins/sdk'], function(exports_1) {
    ...
    var lodash_1, sdk_1;
    var panelDefaults, TextPanelCtrl;
    return {
        setters:[
            function (lodash_1_1) {
                lodash_1 = lodash_1_1;
        ...
        execute: function() {
            ...
            TextPanelCtrl = (function (_super) {
                ...
                TextPanelCtrl.prototype.initEditMode = function () {
                    _super.prototype.initEditMode.call(this);
                    this.icon = 'fa fa-text-width';
                    this.addEditorTab('Options', 'public/app/plugins/panel/text/editor.html');
                    this.editorTabIndex = 1;
                };
                TextPanelCtrl.prototype.refresh = function () {
                    this.render();
                };
                TextPanelCtrl.prototype.render = function () {
                ...
                TextPanelCtrl.prototype.renderMarkdown = function (content) {
                    ...
                    if (this.converter) {
                        ...
                        System.import('vendor/showdown').then(function (Showdown) {
                            _this.converter = new Showdown.converter();
                            _this.$scope.$apply(function () {
                                _this.updateContent(_this.converter.makeHtml(text));
                            });
                        });
                    }
                };
