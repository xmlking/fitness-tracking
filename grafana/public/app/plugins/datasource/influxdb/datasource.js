...
System.register(['lodash', 'app/core/utils/datemath', './influx_series', './influx_query'], function(exports_1) {
    var lodash_1, dateMath, influx_series_1, influx_query_1;
    /** @ngInject */
    function InfluxDatasource(instanceSettings, $q, backendSrv, templateSrv) {
        ...
        this.query = function (options) {
            ...
            var allQueries = lodash_1.default.map(options.targets, function (target) {
                ...
                // build query
                var queryModel = new influx_query_1.default(target);
        ...
        this.metricFindQuery = function (query) {
            ...
            return this._seriesQuery(interpolated).then(function (results) {
                ...
                return lodash_1.default.map(series.values, function (value) {
    ...
    exports_1("InfluxDatasource", InfluxDatasource);
    return {
        setters:[
            function (lodash_1_1) {
                lodash_1 = lodash_1_1;
