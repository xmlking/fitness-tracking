    ...
    return {
        ...
        execute: function() {
            InfluxConfigCtrl = (function () {
                ...
                InfluxConfigCtrl.templateUrl = 'public/app/plugins/datasource/influxdb/partials/config.html';
                return InfluxConfigCtrl;
            })();
            InfluxQueryOptionsCtrl = (function () {
                function InfluxQueryOptionsCtrl() {
                }
                InfluxQueryOptionsCtrl.templateUrl = 'public/app/plugins/datasource/influxdb/partials/query.options.html';
                return InfluxQueryOptionsCtrl;
            })();
            InfluxAnnotationsQueryCtrl = (function () {
                function InfluxAnnotationsQueryCtrl() {
                }
                InfluxAnnotationsQueryCtrl.templateUrl = 'public/app/plugins/datasource/influxdb/partials/annotations.editor.html';
                return InfluxAnnotationsQueryCtrl;
            })();
            exports_1("Datasource", datasource_1.InfluxDatasource);
