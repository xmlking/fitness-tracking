    ...
    return {
        ...
        execute: function() {
            ElasticQueryOptionsCtrl = (function () {
                ...
                ElasticQueryOptionsCtrl.templateUrl = 'public/app/plugins/datasource/elasticsearch/partials/query.options.html';
                return ElasticQueryOptionsCtrl;
            })();
            ElasticAnnotationsQueryCtrl = (function () {
                function ElasticAnnotationsQueryCtrl() {
                }
                ElasticAnnotationsQueryCtrl.templateUrl = 'public/app/plugins/datasource/elasticsearch/partials/annotations.editor.html';
