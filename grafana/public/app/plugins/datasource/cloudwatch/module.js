    ...
    return {
        ...
        execute: function() {
            CloudWatchConfigCtrl = (function () {
                ...
                CloudWatchConfigCtrl.templateUrl = 'public/app/plugins/datasource/cloudwatch/partials/config.html';
                return CloudWatchConfigCtrl;
            })();
            CloudWatchAnnotationsQueryCtrl = (function () {
                function CloudWatchAnnotationsQueryCtrl() {
                }
                CloudWatchAnnotationsQueryCtrl.templateUrl = 'public/app/plugins/datasource/cloudwatch/partials/annotations.editor.html';
